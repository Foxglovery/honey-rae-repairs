...
export const Ticket = ({ ticket, currentUser, getAndSetTickets }) => {
  ...
  //function to delete ticket and refresh
  const handleDelete = () => {
    ...
    <section className="ticket">
      ...
      <footer>
        ...
        <div className="btn-container">
          ...
          {/* when delete clicked, runs delete ticket and updates ticketDeleted state to induce refresh */}
          {/* the double && signifies that if the condition is not met, do nothing */}
          {!currentUser.isStaff && (
            <button
